...
2. "int" - Целое число. Если выставлено, фильтрация по столбцу будет выполнена при помощи попадания в диапазон "от-до".
3. "int~" - То же, что "int", но для значений диапазона. Например, диапазон рабочих частот.
4. "float" - Дробное число. Если выставлено, фильтрация по столбцу будет выполнена при помощи попадания в диапазон "от-до".
